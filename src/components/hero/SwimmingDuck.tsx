...
export const SwimmingDuck: React.FC<SwimmingDuckProps> = ({
  ...
  return (
    <motion.div
      ...
      whileTap={{ scale: 1.35 }}
      className="absolute top-[32%] sm:top-[48%] left-0 cursor-grab active:cursor-grabbing select-none pointer-events-auto p-4 -m-4"
    >
      <motion.div
        animate={
          isGrabbed
            ...
            : isWaddling
              ...
              : currentExpression === 'impact'
                ? { rotate: -10, y: -2 }
                : {
                  // Bob kecil seperti berenang: naik-turun 3px + sway kecil
                  y: [0, -3, 0, 2, 0],
        ...
        transition={{
          ...
          duration: isWaddling ? 0.42 : 2.8,
          ease: 'easeInOut'
        }}
        className="relative group scale-[0.62] sm:scale-100 origin-center"
      >
        {/* Bayangan di atas air — elips transparan */}
        <div className="absolute -bottom-1 left-1 right-1 h-2.5 bg-[#0369a1]/35 rounded-full blur-[3px] scale-x-110" />
        {/* Water-line: efek tubuh bawah bebek setengah tenggelam */}
        <div
          className="absolute bottom-0 left-0 right-0 overflow-hidden pointer-events-none"
          style={{ height: '38%', borderRadius: '0 0 40px 40px' }}
        >
          <div className="w-full h-full bg-[#0ea5e9]/40 backdrop-blur-[1px]" />
        </div>
